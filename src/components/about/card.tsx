...
const About = () => {
  return (
    <div className="bg-redefined-taupe flex justify-center p-20">
      <div className="bg-redefined-rust relative flex w-[95vw] flex-col rounded-4xl p-8 shadow-[15px_10px_0px_#5d5947]">
        <p className="text-redefined-cream font-redefined-chivo relative -top-10 -m-8 text-right text-7xl font-bold italic">
          GET TO KNOW US
        </p>
        <div className="grid grid-cols-2">
          <p className="text-redefined-cream pr-2 text-center text-xl">
